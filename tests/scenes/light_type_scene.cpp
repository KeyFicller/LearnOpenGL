...
light_type_scene::light_type_scene()
    : camera_scene_base("Light Type Test"), m_shader(nullptr) {}
...
void light_type_scene::init(GLFWwindow *_window) {
  ...
  // Load shader
  try {
    m_shader = new shader("shaders/light_type_test/vertex.shader",
                          "shaders/light_type_test/fragment.shader");
    m_light_shader =
        new shader("shaders/light_type_test/vertex.shader",
